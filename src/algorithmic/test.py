...
_('test>=2<=4', 'test>=0<=1', False)
_('test>=2<=4', 'test>=0<=2', True)
_('test>=2<=4', 'test>=0<=3', True)
_('test>=2<=4', 'test>=0<=4', True)
_('test>=2<=4', 'test>=0<=5', True)
_('test>=2<=4', 'test>=1<=2', True)
_('test>=2<=4', 'test>=1<=3', True)
_('test>=2<=4', 'test>=1<=4', True)
_('test>=2<=4', 'test>=1<=5', True)
_('test>=2<=4', 'test>=2<=3', True)
_('test>=2<=4', 'test>=2<=4', True)
_('test>=2<=4', 'test>=2<=5', True)
_('test>=2<=4', 'test>=3<=4', True)
